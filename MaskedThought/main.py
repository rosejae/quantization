...
def main():
    ...
    auto_tokenizer = transformers.AutoTokenizer.from_pretrained(model_name) # TODO: 수정함
    ...
    if train_args.use_peft:
        ...
        if train_args.modules_to_save:
            modules_to_save = ['q_proj', 'k_proj', 'v_proj', 'o_proj', 'gate_proj', 'down_proj', 'up_proj']
    ...
    if hasattr(train_args, "dispatch_batches"):
        delattr(train_args, "dispatch_batches")
        print('completed!!')
